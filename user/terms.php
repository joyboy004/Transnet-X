...
<head>
  ...
  <title>Terms of Service - Transnet X</title>
    ...
    <div class="flex-1 flex flex-col overflow-auto relative">
      <nav class="sticky top-0 z-30 bg-[#0f1219]/90 backdrop-blur-md border-b border-[#242e42] shadow-sm">
        <div class="px-4 sm:px-6 lg:px-8 py-2 md:py-3 flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <h1 class="text-xl md:text-2xl font-bold text-white" style="font-family: 'Merriweather', serif;">Terms of Service</h1>
          </div>
        </div>
      </nav>
      ...
      <div class="flex-1 px-4 sm:px-6 lg:px-8 py-8 w-full max-w-4xl mx-auto">
        <div class="glass-card rounded-2xl p-8 md:p-12 content-prose">
          <h1 class="text-3xl font-bold text-white mb-2" style="font-family: 'Merriweather', serif;">Terms of Service</h1>
          <p class="text-sm mb-6 pb-6 border-b border-gray-800">Last updated: May 2026</p>
          
          <p>Please read these Terms of Service carefully before using the Transnet X platform operated by us.</p>

          <h2>1. Agreement to Terms</h2>
          <p>By accessing or using our Service, you agree to be bound by these Terms. If you disagree with any part of the terms, then you may not access the Service.</p>

          <h2>2. Services Provided</h2>
          <p>Transnet X provides a digital platform that connects users with third-party providers of transportation, logistics, and delivery services. We do not provide transportation or logistics services ourselves, and we are not a transportation carrier.</p>
          ...
          <p>In no event shall Transnet X, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
        </div>
      </div>
    </div>
  </div>
